  ...
  Future<void> _buildIndex() async {
    ...
    try {
      await MutashabihatService.ensureIndexed(onProgress: (loaded, total) {
        if (mounted) {
          setState(() => _status = 'Indexing complete Quran: $loaded / $total ayahs');
        }
      });
      if (mounted) {
        setState(() => _status = 'Complete Quran index ready: 6,236 / 6,236 ayahs');
      }
    } catch (error) {
      ...
      child: LayoutBuilder(
        builder: (context, constraints) => SingleChildScrollView(
          padding: EdgeInsets.fromLTRB(
            constraints.maxWidth > 700 ? 40 : 18,
            24,
            constraints.maxWidth > 700 ? 40 : 18,
            100,
          ),
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Complete Quran-wide similarity search • 6,236 ayahs',
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'This is not a selective list. The engine indexes the complete Quran, normalizes Arabic wording, finds shared multi-word phrases, and ranks similar passages for side-by-side Hifz comparison.',
                          ),
                          const SizedBox(height: 12),
                          Row(
                            children: [
                              Expanded(child: Text(_status, style: theme.textTheme.bodySmall)),
                              if (!MutashabihatService.isReady)
                                FilledButton.tonal(
                                  onPressed: busy ? null : _buildIndex,
                                  child: Text(_indexing ? 'Indexing…' : 'Build full index'),
                                ),
                            ],
                          ),
                        ],
                  ...
                  if (_selectedAyah != null) ...[
                    ...
                    _AyahCard(
                      title: 'Selected ayah • ${_selectedAyah!.surah}:${_selectedAyah!.ayah}',
                      ayah: _selectedAyah!,
                      highlight: null,
                    ),
                  ],
                          ...
                          child: Column(
                            ...
                            children: [
                              Wrap(
                                ...
                                runSpacing: 8,
                                children: [
                                  Chip(label: Text('${match.score}% similarity')),
                                  Chip(label: Text('${match.target.surah}:${match.target.ayah}')),
                                ],
                              ),
      ...
      child: Column(
        ...
        children: [
          ...
          SelectableText(
            ...
            style: theme.textTheme.titleMedium?.copyWith(height: 1.9, fontWeight: FontWeight.w700),
          ),
          if (highlight != null) ...[
            const SizedBox(height: 8),
            Text('Match: $highlight', textDirection: TextDirection.rtl, style: theme.textTheme.bodySmall),
          ],
        ],
      ),
    );
